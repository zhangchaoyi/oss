...
//Echart --newPlayers--首次游戏 + 小号分析 + 地区 + 国家 + 性别 + 年龄 + 账户类型
$(function() {
...
$(function() {
    var firstGamePeriodData = [["1-4 s", "10", "5%"], ["5-10 s", "20", "10%"], ["11-30 s", "30", "15%"], ["31-60 s", "40", "20%"], ["1-3 min", "0", "0"], ["3-10 min", "40", "20%"], ["10-30 min", "30", "15%"], ["30-60 min", "20", "10%"], [">60 min", "10", "5%"], ];
    var smallAccount = [["未统计", 0, 0], ["1", 6, "6%"], ["2", 16, "16%"], ["3", 8, "8%"], ["4", 16, "16%"], ["5", 4, "4%"], ["6", 20, "20%"], ["7", 10, "10%"], ["8-10", 10, "10%"], [">10", 10, "10%"]];

    var areaData = [["广东省", 9, "90%"], ["-", 1, "10%"]];

    var countryData = [["中国", 90, "90%"], ["-", 10, "10%"]];

    var sexData = [["男", 50, "50%"], ["女", 40, "40%"], ["未知", 10, "10%"]];

    var ageData = [["1-15", 10, "10%"], ["16-20", 0, 0], ["21-25", 0, 0], ["26-30", 20, "20%"], ["31-35", 30, "30%"], ["36-40", 40, "40%"], ["41-45", 0, 0], ["46-50", 40, "40%"], ["51-55", 30, "30%"], ["56-60", 20, "20%"], [">60", 10, "10%"], ["未知", 0, 0]];
...
$(function() {
    var data = [["2016-08-11", 30, 2, 0], ["2016-08-12", 48, 5, 5], ["2016-08-13", 13, 20, 4], ["2016-08-14", 8, 5, 5], ["2016-08-15", 3, 2, 4], ["2016-08-16", 4, 51, 50], ["2016-08-17", 48, 5, 50], ["2016-08-18", 30, 2, 40]];

    var userChangeData = [["2016-08-11", "10%"], ["2016-08-12", "20%"], ["2016-08-13", "30%"], ["2016-08-14", "40%"], ["2016-08-15", "50%"], ["2016-08-16", "40%"], ["2016-08-17", "30%"], ["2016-08-18", "20%"]];
