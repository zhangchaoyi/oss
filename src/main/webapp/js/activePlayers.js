...
function loadActiveDetailData(tagDetailInfo) {
	$.post("/api/player/active/details", {
...
function dealTableData(data,details) {
    var type = data.type;
    var categories;
    var sum = 0;
...
$("ul.nav.nav-tabs.activeplayer > li").click(function(){
	var playerTag = $(this).children("a").attr("data-info");
	loadActivePlayerData(playerTag);
});
