...
function configTable(data){
	...
	$("#incomeTotal").text(globalCurrency + data["rT"]);
	$("#arpuTotal").text(globalCurrency + data["arpuTotal"]);
	...
	$("#income").text(globalCurrency + data["rY"]);
	$("#arpu").text(globalCurrency + data["arpuY"]);
	...
	$("#iOS-rT").text(globalCurrency + data["iOSRT"]);
	$("#iOS-rN").text(globalCurrency + data["iOSRN"]);
	...
	$("#and-rT").text(globalCurrency + data["androidRT"]);
	$("#and-rN").text(globalCurrency + data["androidRN"]);
	...
	$("#wp-rT").text(globalCurrency + data["windowsRT"]);
	$("#wp-rN").text(globalCurrency + data["windowsRN"]);
	...
	$("#rT-sum").text(globalCurrency + data["revenueTSum"]);
	$("#rN-sum").text(globalCurrency + data["revenueNSum"]);
	...
	$("#rT-sum-total").text(globalCurrency + data["revenueTSum"]);
	$("#rN-sum-total").text(globalCurrency + data["revenueNSum"]);
};
